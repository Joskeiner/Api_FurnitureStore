...
try 
{
    ...
    //agregar esquema JWT Y Refresh token 
    var key = Encoding.ASCII.GetBytes(builder.Configuration.GetSection("JwtConfig:secret").Value);
    var tokenValidationParameters = new Microsoft.IdentityModel.Tokens.TokenValidationParameters()// Aquí se configuran los parámetros de validación del token JWT. Estos parámetros se utilizan para validar la firma y las propiedades del token.
    {
